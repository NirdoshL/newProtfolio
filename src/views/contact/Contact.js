      ...
      <Jumbotron className="contact-jumbotron">
        <Row>
          <Col className="d-flex justify-content-center flex-wrap">
            <div className="m-2">
              <a href="mailto:nirdoshlamixane001@gmail.com" target="_blank" rel="noopener noreferrer">
                <Button variant="outline-danger" title="nirdoshlamixane001@gmail.com">
            ...
            <div className="m-2">
              <a href="https://www.instagram.com/_nirdosh.l/" target="_blank" rel="noopener noreferrer">
